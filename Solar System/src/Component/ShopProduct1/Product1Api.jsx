    ...
    const fetchProductData = async () => {
      try {
        ...
        switch (selectedProduct?.id) {
          case 1:
            response = await fetch('http://13.49.73.215:5000/api/users/product1');
            break;
          case 2:
            response = await fetch('http://13.49.73.215:5000/api/users/product2');
            break;
          case 3:
            response = await fetch('http://13.49.73.215:5000/api/users/product3');
            break;
          case 4:
            response = await fetch('http://13.49.73.215:5000/api/users/product4');
            break;
          case 5:
            response = await fetch('http://13.49.73.215:5000/api/users/product5');
            break;
          case 6:
            response = await fetch('http://13.49.73.215:5000/api/users/product6');
            break;
          case 7:
            response = await fetch('http://13.49.73.215:5000/api/users/product7');
            break;
          case 8:
            response = await fetch('http://13.49.73.215:5000/api/users/product8');
            break;
          default:
